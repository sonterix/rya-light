...
| 2        | 002 | `002-seed-data-setup-script.md`                   | Seed data and setup script                         | Done    | 1        | `001-database-schema-migrations-rls.md`                                                           |
| 2        | 004 | `004-sign-in-sign-up-page.md`                     | Sign in and sign up page                           | Done    | 1        | `003-supabase-auth-clients-middleware.md`                                                         |
...
| 3        | 006 | `006-respondent-explorer-page.md`                 | Respondent explorer page                           | Ready   | 0        | `001-database-schema-migrations-rls.md`, `005-app-shell-sidebar-providers.md`                     |
| 3        | 007 | `007-audience-builder-create-list.md`             | Audience builder - create and list                 | Ready   | 0        | `001-database-schema-migrations-rls.md`, `005-app-shell-sidebar-providers.md`                     |
